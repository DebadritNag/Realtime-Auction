...
export function ManagerSetup({ auctionId }: {
    ...
    async function submit() { setBusy(true); setError(''); try {
        const t = await managerService.create(auctionId, { name, startingBudgetUnits: croreToUnits(Number(budget)), csv, format });
