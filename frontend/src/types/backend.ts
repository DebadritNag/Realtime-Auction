...
TRANSFER_WINDOW_CLOSED:{tournamentId:string};
 NOTIFICATION_CREATED:TournamentState['notifications'][number];
 MANAGER_MODE_PATCH:{tournamentId:string;baseSequence:number;changes:Partial<TournamentState>};MANAGER_MODE_SUMMARY:TournamentSummary;PLAYER_RELEASED:{tournamentId:string};FREE_AGENT_POOL_UPDATED:{tournamentId:string};
