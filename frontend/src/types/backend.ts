...
SEASON_BONUSES_AWARDED:{tournamentId:string};
NEXT_SEASON_STARTED:{tournamentId:string};
MANAGER_MODE_ENDED:{tournamentId:string};
...
FREE_AGENT_ACCEPTED:{tournamentId:string};
FREE_AGENT_SIGNED:{tournamentId:string};
FREE_AGENT_SIGNED_ELSEWHERE:{tournamentId:string};
TRADE_CREATED:{tournamentId:string};
TRADE_UPDATED:{tournamentId:string};
PLAYER_TRANSFERRED:{tournamentId:string};
TRANSFER_WINDOW_OPENED:{tournamentId:string};
TRANSFER_WINDOW_CLOSED:{tournamentId:string};
 MANAGER_MODE_STATE:TournamentState;MANAGER_MODE_INBOX:TournamentSummary[];
 MANAGER_MODE_CREATED:{tournamentId:string};MANAGER_MODE_UPDATED:{tournamentId:string};MANAGER_MODE_DELETED:{tournamentId:string};
