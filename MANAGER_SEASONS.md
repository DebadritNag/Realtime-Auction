...
Default position bonuses in Cr: 30, 24, 20, 16, 12, 10, 8, 6, 4, 2. Positions beyond ten default to ₹1 Cr. Every finishing team receives a positive bonus. Legacy zero awards in settings become a ₹0.5 Cr minimum for future completions; already-awarded history is not rewritten. Host configuration requires one non-increasing, positive integer-unit amount per team. Changes do not rewrite previous awards. Starting a season never re-adds old rewards.
